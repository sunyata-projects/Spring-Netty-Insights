 ...
 */
@Component
@BusinessComponent(businName = "TestBusinessComponent", bisinFriendlyName = "TestBusinessComponent", version = "1.0",
        description =
        "desc",
        compensationSwitch = false)
public class TestBusinessComponent extends AbstractBusinessComponent<FooFlow, DefaultExecutor> {
    ...
    public FooFlow initializeFlow() throws Exception {
        QuarkComponentDescriptor barQuarkComponent = RemoteQuarkComponentDescriptorFactory.getDescriptor
                ("quark-provider-1", "AsyncQuarkComponent").setAsync(true);
        barQuarkComponent.getOptions().setRetryLimitTimes(-1);
