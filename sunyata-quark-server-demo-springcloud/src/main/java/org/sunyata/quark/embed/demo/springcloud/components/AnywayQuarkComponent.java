 ...
 */
@Component
@QuarkComponent(quarkName = "AnywayQuarkComponent", quarkFriendlyName = "AnywayQuarkComponent", version = "1.0")
public class AnywayQuarkComponent extends AbstractQuarkComponent {

    public AnywayQuarkComponent() {
    }
