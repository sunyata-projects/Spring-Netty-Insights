 ...
 */
@Component
@QuarkComponent(quarkName = "SuccessQuarkComponent3", quarkFriendlyName = "SuccessQuarkComponent3", version = "1.0")
public class SuccessQuarkComponent3 extends AbstractQuarkComponent {

    public SuccessQuarkComponent3() {
    }
    ...
    public ProcessResult execute(QuarkParameterInfo parameterInfo) {
        ...
        Object test1 = parameterInfo.getBusinessContext().getParameter("test1", "defaultValueTest1");
        System.out.println(test1);
        return ProcessResult.s().setOutputParameter("testSuccess3", "testSuccessValue3");
    }
