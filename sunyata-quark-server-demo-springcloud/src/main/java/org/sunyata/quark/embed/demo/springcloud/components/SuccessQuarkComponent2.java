 ...
 */
@Component
@QuarkComponent(quarkName = "SuccessQuarkComponent2", quarkFriendlyName = "SuccessQuarkComponent2", version = "1.0")
public class SuccessQuarkComponent2 extends AbstractQuarkComponent {

    public SuccessQuarkComponent2() {
    }
    ...
    public ProcessResult execute(QuarkParameterInfo parameterInfo) {
        HashMap<String, Object> outputParameters = parameterInfo.getBusinessContext().getInstance()
                .getOutputParameters();
        Object orDefault = outputParameters.getOrDefault("testParameter1", "testValue");
        System.out.println("hello world:" + orDefault);
        Object parameter = parameterInfo.getBusinessContext().getParameter("key1", "defaultValue");
        System.out.println(parameter);
        return ProcessResult.s().setOutputParameter("test1", "testValue2");
    }
