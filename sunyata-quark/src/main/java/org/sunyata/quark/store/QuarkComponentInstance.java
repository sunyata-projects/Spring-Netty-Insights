...
public class QuarkComponentInstance implements Serializable {
    ...
    public QuarkComponentInstance setBusinItemCode(String businItemCode) {
    ...
    public QuarkComponentInstance setBusinItemName(String businItemName) {
...
//    private CanContinueTypeEnum canContinue;
    ...
    public int hashCode() {
        ...
        return new HashCodeBuilder(17, 37).append(this.getProcessResult()).append(this.getNotes()).append(this
                .getExecuteTimes()).append(getCompensationProcessResult()).toHashCode();
    }
