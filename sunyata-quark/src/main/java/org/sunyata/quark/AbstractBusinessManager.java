...
//    }
    ...
    @Override
    public void initialize(MessageQueueService queueService) {
...
//            messageQueueService.enQueue(instance.getBusinName(), instance.getBusinName(), delay, instance.getSerialNo(),
//                    false);
//        }
//    }
...
//                    .currentTimeMillis());
//            long delay = instance.getCreateDateTime().getTime() - System.currentTimeMillis();
//            messageQueueService.enQueue(instance.getBusinName(), instance.getBusinName(), delay, instance.getSerialNo(), true);
//        }
//    }
    ...
    public <T extends AbstractBusinessComponent> void register(Class<T> businessComponentClass) throws Exception {
        ...
        if (businessComponentMaps.getOrDefault(annotation.businName(), null) == null) {
            logger.info("注册组件:{}", businessComponentClass.getName());
