...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
        ...
        protected final void restructureIfNecessary(boolean allowResize) {
            ...
            if ((reference != null) || (needsResize && allowResize)) {
                ...
                try {
                    ...
                    Reference<K, V>[] restructured = (resizing ? createReferenceArray(restructureSize) : this
                            .references);
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            if (o != null && o instanceof Map.Entry<?, ?>) {
                ...
                Reference<K, V> reference = ConcurrentReferenceHashMap.this.getReference(entry.getKey(), Restructure
                        .NEVER);
    ...
    private static final class SoftEntryReference<K, V> extends SoftReference<Entry<K, V>> implements Reference<K, V> {
        ...
        public SoftEntryReference(Entry<K, V> entry, int hash, Reference<K, V> next, ReferenceQueue<Entry<K, V>>
                queue) {
            super(entry, queue);
            this.hash = hash;
    ...
    private static final class WeakEntryReference<K, V> extends WeakReference<Entry<K, V>> implements Reference<K, V> {
        ...
        public WeakEntryReference(Entry<K, V> entry, int hash, Reference<K, V> next, ReferenceQueue<Entry<K, V>>
                queue) {
            super(entry, queue);
            this.hash = hash;
            this.nextReference = next;
