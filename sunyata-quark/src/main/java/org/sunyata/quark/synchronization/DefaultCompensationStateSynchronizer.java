 ...
 */
public class DefaultCompensationStateSynchronizer implements CompensationStateSynchronizer {
    public void sync(AbstractBusinessComponent businessComponent, BusinessContext businessContext,
                     ProcessResult
