 ...
 */
@Component("MatchRatingForPlayerQuarkComponent")
@QuarkComponent(quarkName = "MatchRatingForPlayerQuarkComponent", quarkFriendlyName =
        "MatchRatingForPlayerQuarkComponent", version = "1.0")
public class MatchRatingForPlayerQuarkComponent extends AbstractQuarkComponent<MatchRatingForPlayerQuarkComponent
