 ...
 */
@Component("MatchUnBindBonusQuarkComponent")
@QuarkComponent(quarkName = "MatchUnBindBonusQuarkComponent", quarkFriendlyName = "MatchUnBindBonusQuarkComponent", version = "1.0")
public class MatchUnBindBonusQuarkComponent extends AbstractQuarkComponent<MatchUnBindBonusQuarkComponent.BarQuarkParameterInfo> {
