 ...
 */
@Component("MatchRankCheckQuarkComponent")
@QuarkComponent(quarkName = "MatchRankCheckQuarkComponent", quarkFriendlyName = "MatchRankCheckQuarkComponent",
        version = "1.0")
public class MatchRankCheckQuarkComponent extends AbstractQuarkComponent<MatchRankCheckQuarkComponent
