 ...
 */
@Component("AsyncQuarkComponent")
@QuarkComponent(quarkName = "AsyncQuarkComponent", quarkFriendlyName = "AsyncQuarkComponent", version = "1.0")
public class AsyncQuarkComponent extends AbstractQuarkComponent<AsyncQuarkComponent.AsyncQuarkParameterInfo> {
