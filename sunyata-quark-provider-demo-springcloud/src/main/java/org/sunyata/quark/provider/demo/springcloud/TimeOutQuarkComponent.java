 ...
 */
@Component("TimeOutQuarkComponent")
@QuarkComponent(quarkName = "TimeOutQuarkComponent", quarkFriendlyName = "TimeOutQuarkComponent", version = "1.0")
public class TimeOutQuarkComponent extends AbstractQuarkComponent<TimeOutQuarkComponent.BarQuarkParameterInfo> {
