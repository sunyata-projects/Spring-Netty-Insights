...
//
//    @Override
//    public BusinessComponentInstance create(String serialNo, String businName, String sponsor, String relationId, String parameterString,
...
//
//
//    public void run(String serialNo,String businName) throws Exception {
...
////            }
////        });
//        new PublicRunCommand(businName, this,serialNo,messageQueueService).queue();
//    }
//
//
//
