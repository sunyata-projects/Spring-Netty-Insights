 ...
 */
@Component
@BusinessComponent(businName = "MatchRewardForSinglePlayerComponent", bisinFriendlyName = "MatchRewardForSinglePlayerComponent", version = "1.0",
        description = "desc", compensationSwitch = false)
public class MatchRewardForSinglePlayerComponent extends AbstractBusinessComponent<FooFlow, DefaultExecutor> {
        ...
        Orchestration<FooFlow> orchestration =
                new DefaultOrchestration<FooFlow>()
                        ...
                        .beginWith(RemoteQuarkComponentDescriptorFactory.getDescriptor("quark-provider-1",
                                "MatchRewardForSinglePlayerQuarkComponent"))
                        .succeed()
