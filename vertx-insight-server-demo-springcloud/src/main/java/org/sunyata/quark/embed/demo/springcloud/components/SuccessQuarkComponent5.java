 ...
 */
@Component
@QuarkComponent(quarkName = "SuccessQuarkComponent5", quarkFriendlyName = "SuccessQuarkComponent5", version = "1.0")
public class SuccessQuarkComponent5 extends AbstractQuarkComponent {

    public SuccessQuarkComponent5() {
    }
