...
public class TimeOutQuarkComponent extends AbstractQuarkComponent {
    ...
    public TimeOutQuarkComponent() {
    }

    @Override
    public ProcessResult execute(QuarkParameterInfo parameterInfo) throws InterruptedException {
        Thread.sleep(100000);
