 ...
 */
@Component("MatchRewardForSinglePlayerQuarkComponent")
@QuarkComponent(quarkName = "MatchRewardForSinglePlayerQuarkComponent", quarkFriendlyName = "MatchRewardForSinglePlayerQuarkComponent",
        version = "1.0")
public class MatchRewardForSinglePlayerQuarkComponent extends AbstractQuarkComponent<MatchRewardForSinglePlayerQuarkComponent
