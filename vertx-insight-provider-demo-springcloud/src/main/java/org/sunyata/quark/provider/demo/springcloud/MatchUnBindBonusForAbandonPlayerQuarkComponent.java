 ...
 */
@Component("MatchUnBindBonusForAbandonPlayerQuarkComponent")
@QuarkComponent(quarkName = "MatchUnBindBonusForAbandonPlayerQuarkComponent", quarkFriendlyName =
        "MatchUnBindBonusForAbandonPlayerQuarkComponent", version = "1.0")
public class MatchUnBindBonusForAbandonPlayerQuarkComponent extends
        AbstractQuarkComponent<MatchUnBindBonusForAbandonPlayerQuarkComponent.BarQuarkParameterInfo> {
