 ...
 */
@Component("MatchInitRewardQuarkComponent")
@QuarkComponent(quarkName = "MatchInitRewardQuarkComponent", quarkFriendlyName = "MatchInitRewardQuarkComponent",
        version = "1.0")
public class MatchInitRewardQuarkComponent extends AbstractQuarkComponent<MatchInitRewardQuarkComponent
